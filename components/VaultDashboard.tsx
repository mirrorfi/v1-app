...
import { VaultDashboardTransactionHistory, type Transaction } from "@/components/VaultDashboardTransactionHistory"
...
export function VaultDashboard({
  ...
  //     signature: "5kJ8fKgF9xGN7vYfZ2QwHhB7dF3xDqE8mPvT9xRwL2xH3cV6nB4jK8fG9xE7dC2zA1",
  //     status: "completed",
  //   },
  //   {
  //     id: "2",
  ...
  //     signature: "3zH7kL9mN5pQ8rT2wX4yA6bC1dE9fG2hJ3kL5mN8pQ7rT9wX2yA4bC6dE8fG1hJ4",
  //     status: "completed",
  //   },
  //   {
  //     id: "3",
  ...
  //     signature: "8mN2pQ5rT7wX9yA1bC3dE5fG7hJ9kL1mN3pQ5rT7wX9yA1bC3dE5fG7hJ9kL2",
  //     status: "completed",
  //   },
  // ])
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-3">
                  ...
                  <Button
                    onClick={handleBackClick}
                    variant="outline"
                    className="border-slate-500/30 text-slate-400 hover:bg-slate-500/10 hover:border-slate-500/50 bg-transparent"
                  >
                    <ArrowLeft className="h-4 w-4 mr-2" />
                    Go Back
                  </Button>
              ...
              {activeTab == "your-position" && (
                <div className="xl:col-span-2 space-y-4 order-2 xl:order-1">
                  <VaultDashboardPNLCard
                    ...
                    isLoading={isLoading}
                  />
                  <VaultDashboardTransactionHistory transactions={transactions} isLoading={isLoading} />
