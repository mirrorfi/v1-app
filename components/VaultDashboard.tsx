...
import { Transaction, VaultDashboardTransactionHistory } from "./VaultDashboardTransactionHistory";
import { VaultDashboardSkeleton } from "./VaultDashboardSkeleton";
...
export function VaultDashboard({
  ...
  const hasManagingAuthority =
    publicKey && vaultData && publicKey.toString() === vaultData.authority;
          ...
          <div className="mb-6 flex items-center gap-4">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-bold text-white">
                {vaultData?.name ||
                  depositData?.tokenInfo?.symbol + " Vault" ||
                  "Vault Dashboard"}
              </h1>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-5 gap-4">
                  ...
                  <div className="xl:col-span-2 space-y-4 order-1 xl:order-1">
                    ...
                    <VaultDashboardPNLCard
                      ...
                      depositData={depositData}
                    />
                    <VaultDashboardTransactionHistory transactions={transactions} />
                    {/*Asset Allocation*/}
                    {/*<VaultAllocation
                depositData={depositData}
                strategiesData={strategiesData}
