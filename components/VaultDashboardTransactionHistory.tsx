...
export function VaultDashboardTransactionHistory({
  ...
  return (
    <Card className="bg-gradient-to-br from-slate-900/50 to-slate-800/30 border-slate-700/50 backdrop-blur-sm rounded-lg shadow-lg z-10">
      <CardHeader>
          ...
          <div className="space-y-3">
            {transactions.map((transaction) => (
              <div
                ...
                className="relative flex items-center justify-between p-4 bg-slate-800/40 rounded-lg border border-slate-700/30 hover:bg-slate-800/60 transition-colors cursor-pointer"
...
export function VaultDashboardTransactionHistorySkeleton() {
  return (
    <Card className="bg-gradient-to-br from-slate-900/50 to-slate-800/30 border-slate-700/50 backdrop-blur-sm rounded-lg shadow-lg">
      <CardHeader>
